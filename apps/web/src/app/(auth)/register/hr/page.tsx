...
const registerSchema = z
  .object({
    ...
    orgSize: z.string().min(1, "Xodimlar sonini tanlang"),
    orgType: z.string().min(1, "Faoliyat sohasini tanlang"),
...
const STEPS = [
  { id: 1, title: "Korxona ma'lumotlari" },
...
export default function HRRegisterPage() {
  ...
  const onSubmit = async (data: RegisterForm) => {
    ...
    try {
      ...
      toast.success("HR Cloud hisob muvaffaqiyatli yaratildi!");
      router.push('/login?cloud=hr');
    } catch (err: unknown) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 flex items-start justify-center p-4 py-8">
      <div className="w-full max-w-5xl">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center gap-3 mb-3">
            <h1 className="text-2xl md:text-3xl font-bold text-white">
              🏢 HR Cloud — Ro&apos;yxatdan o&apos;tish
            </h1>
          </div>
          <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-full text-white text-sm font-bold shadow-lg shadow-blue-500/30">
        ...
        {/* Two-column layout: form + feature panel */}
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">
                      Tashkilotingiz haqida asosiy ma&apos;lumotlarni kiriting
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      {...register('orgName')}
                      className="w-full px-3 py-2.5 text-sm border border-white/10 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white/5 text-white placeholder:text-slate-500"
                      placeholder="Nexus Group LLC"
                    />
                    {errors.orgName && (
                        ...
                        <label key={size} className="cursor-pointer">
                          ...
                          <div
                            className={`text-center py-2 rounded-lg border text-xs font-semibold transition-all ${
                              watch('orgSize') === size
                                ? 'border-blue-500 bg-blue-600/40 text-blue-300'
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-slate-300 mb-1.5">
                      <Target className="inline w-4 h-4 mr-1 text-blue-400" />
                      Faoliyat sohasi *
                    </label>
                    <select
                      {...register('orgType')}
                      className="w-full px-3 py-2.5 text-sm border border-white/10 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-slate-800 text-white"
                    >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-3 py-2.5 text-sm border border-white/10 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white/5 text-white placeholder:text-slate-500 pr-10"
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        {...register('telegramId')}
                        className="w-full pl-8 pr-3 py-2.5 text-sm border border-white/10 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white/5 text-white placeholder:text-slate-500"
                        placeholder="username"
                      />
                    </div>
                    <p className="text-xs text-slate-500 mt-1">
                      Bot: <span className="font-mono text-blue-400">@IDTrustBot</span>
                    </p>
                  </div>
              ...
              <div className={`flex mt-7 gap-3 ${step > 1 ? 'justify-between' : 'justify-end'}`}>
                ...
                {step < 3 ? (
                  <button
                    type="button"
                    onClick={nextStep}
                    className="flex items-center gap-1.5 px-6 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl text-sm font-bold hover:opacity-90 transition-all shadow-lg shadow-blue-500/30"
                  >
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl text-sm font-bold hover:opacity-90 disabled:opacity-60 transition-all shadow-lg shadow-blue-500/30"
                  >
                    {isLoading ? (
                      <>
                      ...
                      <>
                        HR Cloud&apos;ni boshlash <ChevronRight className="w-4 h-4" />
                      </>
                    )}
                  </button>
                )}
            ...
            <div className="mt-6 pt-5 border-t border-white/10">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-slate-400">200+ kompaniya</span>
                </div>
                <div className="flex items-center gap-2">
                  <Target className="w-4 h-4 text-blue-400" />
                  <span className="text-xs text-slate-400">10,000+ xodim boshqarilmoqda</span>
                </div>
                <div className="flex items-center gap-2">
